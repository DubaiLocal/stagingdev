...
class SubCategoryController extends BaseController
{
    ...
    public function save()
    {
        ...
        $save = $SubCategoryModel->add_sub_cat($name, $cat_id, $slug, $image, $sub_cat_icon, $isactive);
        if ($save) {
    ...
    public function update($id)
    {
        if ($this->IsloggedIn()) {
            ...
            $cat_id = $this->request->getvar('category');
            $isactive = $this->request->getvar('is_active');
            $update = $SubCategoryModel->update_sub_cat($id, $cat_id, $name, $slug, $image, $sub_cat_icon,  $isactive);
            if ($update) {
