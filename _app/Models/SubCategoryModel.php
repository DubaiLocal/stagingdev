...
class SubCategoryModel extends Model
{
    ...
    //  add sub category
    public function add_sub_cat($name, $cat_id, $slug, $image, $cat_icon, $status)
    {
        $db      = \Config\Database::connect();
        $builder = $db->table('sub_category');
        $data_array = array(
    ...
    //  update category
    public function update_sub_cat($id, $cat_id, $name, $slug, $image, $sub_cat_icon, $status)
    {
        $db      = \Config\Database::connect();
        $builder = $db->table('sub_category');
        $data_array = array(
    ...
    public function get_keywords_id($category){
        $db      = \Config\Database::connect();
        $builder = $db->table('sub_category_keywords');
        $builder->select('sub_category_keywords.id');
        $builder->join('sub_category', 'sub_category.id= sub_category_keywords.subcategory_id');
    ...
    public function save_keywords($subcategory_id, $name, $url, $source)
    {
        $db      = \Config\Database::connect();
        $builder = $db->table('sub_category_keywords');
        $data_array = array(
