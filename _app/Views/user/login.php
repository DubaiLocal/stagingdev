							...
							<div class="auth-form-wrap pt-xl-0 pt-70">
								<div class="auth-form w-xl-35 w-lg-65 w-sm-85 w-100 card pa-40 shadow-lg">
									<a class="auth-brand text-center d-block mb-20" href="#">
										<img class="brand-img" src="<?php echo base_url(); ?>/assets/front/images/logo.png" alt="brand" />
									</a>
									<form action="<?php echo base_url(); ?>/user/login" method="POST" id="login" autocomplete="false">
										...
										<p class="text-center mt-2">Don't have an account? <a href="<?= base_url(); ?>/register">Register</a></p>
									</form>
								</div>
							</div>
						</div>
