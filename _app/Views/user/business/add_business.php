            ...
            <div class="row">
               ...
               <div class="col-lg-6 col-sm-6 col-12">
                  <div class="form-group">
                     ...
                     <input class="form-control multi with-preview" name="more_images[]" multiple="" id="more_images" type="file" accept="jpg|jpeg|png" data-maxfile="1024" style="height:auto">
                  </div>
               </div>
