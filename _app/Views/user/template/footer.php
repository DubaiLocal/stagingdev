    ...
    $("#logo").change(function() {
        ...
        if ((file = this.files[0])) {
            ...
            image.onload = function() {
                if (this.width < 590 || this.height < 375) {
                    // alert("Minimum Resolution should be 590px x 375px");
                    Swal.fire({
                        title: 'Minimum Resolution should be 590px x 375px',
...
<script>
    ...
    $("#save_business").validate({
        ...
        submitHandler: function(form) {
            ...
            console.log("test");
            debugger; */
            for (var i = 0; i < $("#more_images").files.length; i++) {
                var file = $("#more_images").files[i];
                var img = new Image();
                img.onload = function() {
