        ...
        <div class="slider_form test">
            ...
            <form method="get" action="<?= base_url(); ?>/search">
                ...
                <div class="form-group location_btn_set">
                    ...
                    <input type=" text" name="query" id="query" autocomplete="off" class="form-control" placeholder="Search Business..." />
                    <!-- <button onclick="getLocation()" type="button" class="btn btn-primaryy butn_position" ><i class="fa fa-map-marker" aria-hidden="true"></i> &nbsp; Current Location</button> -->
...
<section class="our_features_grid">
    <div class="container">
            ...
            <div id="upcoming_events" class="owl-carousel owl-theme">
                ...
                <div class="item">
                    <div class="card article-card border-0">
                        <a href="<?= getenv('BLOG_BASE_URL'); ?>/blog/martin-garrix-live-in-dubai/" target="_blank">
                            <div class="position-relative"> <img class="card-img" src="<?= getenv('BLOG_BASE_URL'); ?>/wp-content/uploads/2022/12/4.jpg" alt="Card image"> </div>
                            <div class="card-body px-0 pt-3"> <span class="article-types">Martin Garrix Live in Dubai</span>
                ...
                <div class="item">
                    <div class="card article-card border-0">
                        <a href="<?= getenv('BLOG_BASE_URL'); ?>/blog/atlantis-gala-dinner-a-night-with-the-star-featuring-kylie-minogue-in-dubai/" target="_blank">
                            <div class="position-relative"> <img class="card-img" src="<?= getenv('BLOG_BASE_URL'); ?>/wp-content/uploads/2022/12/5.jpg" alt="Card image"> </div>
                            <div class="card-body px-0 pt-3"> <span class="article-types">Atlantis Gala Dinner "A Night With The Star" Featuring Kylie Minogue in Dubai</span>
                ...
                <div class="item">
                    <div class="card article-card border-0">
                        <a href="<?= getenv('BLOG_BASE_URL'); ?>/blog/havasi-drum-and-piano-concert/" target="_blank">
                            <div class="position-relative"> <img class="card-img" src="<?= getenv('BLOG_BASE_URL'); ?>/wp-content/uploads/2022/12/25.jpg" alt="Card image"> </div>
                            <div class="card-body px-0 pt-3"> <span class="article-types">Havasi Drum and Piano Concert</span>
                                <!-- <h5 class="card-title article-heading"><a href="#" class="btn-link text-reset fw-bold"><span class="ev_price">14.03 USD</span> <span class="ev_user"><i class="fa fa-user" aria-hidden="true"></i> 305</span> <span class="ev_views"><i class="fa fa-eye" aria-hidden="true"></i> 9 looking now</span></a></h5>-->
                                <!--<p class="article-date"><span>May 01st, 2022</span> by <span class="created-by">Admin</span></p>-->
                            </div>
                        </a>
                ...
                <div class="item">
                    <div class="card article-card border-0">
                        <a href="<?= getenv('BLOG_BASE_URL'); ?>/blog/award-winning-composer-hans-zimmer-to-perform-in-dubai-in-january-2023/" target="_blank">
                            <div class="position-relative"> <img class="card-img" src="<?= getenv('BLOG_BASE_URL'); ?>/wp-content/uploads/2022/12/26-1.jpg" alt="Card image"> </div>
                            <div class="card-body px-0 pt-3"> <span class="article-types">Award-winning composer Hans Zimmer to perform in Dubai in January 2023</span>
                                <!-- <h5 class="card-title article-heading"><a href="#" class="btn-link text-reset fw-bold"><span class="ev_price">14.03 USD</span> <span class="ev_user"><i class="fa fa-user" aria-hidden="true"></i> 305</span> <span class="ev_views"><i class="fa fa-eye" aria-hidden="true"></i> 9 looking now</span></a></h5>-->
                                <!--<p class="article-date"><span>May 01st, 2022</span> by <span class="created-by">Admin</span></p>-->
                            </div>
                        </a>
                ...
                <div class="item">
                    <div class="card article-card border-0">
                        <a href="<?= getenv('BLOG_BASE_URL'); ?>/blog/desert-groove-by-groove-on-the-grass-returns-in-january-2023/" target="_blank">
                            <div class="position-relative"> <img class="card-img" src="<?= getenv('BLOG_BASE_URL'); ?>/wp-content/uploads/2022/12/27-1.jpg" alt="Card image"> </div>
                            <div class="card-body px-0 pt-3"> <span class="article-types">Desert Groove by Groove on the Grass returns in January 2023</span>
                                <!-- <h5 class="card-title article-heading"><a href="#" class="btn-link text-reset fw-bold"><span class="ev_price">14.03 USD</span> <span class="ev_user"><i class="fa fa-user" aria-hidden="true"></i> 305</span> <span class="ev_views"><i class="fa fa-eye" aria-hidden="true"></i> 9 looking now</span></a></h5>-->
                                <!--<p class="article-date"><span>May 01st, 2022</span> by <span class="created-by">Admin</span></p>-->
                            </div>
                        </a>
