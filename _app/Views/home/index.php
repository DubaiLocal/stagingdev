            ...
            <div id="upcoming_events" class="owl-carousel owl-theme">
                ...
                <div class="item">
                    <div class="card article-card border-0">
                        <a href="<?= getenv('BLOG_BASE_URL'); ?>/martin-garrix-live-in-dubai/" target="_blank">
                ...
                <div class="item">
                    <div class="card article-card border-0">
                        <a href="<?= getenv('BLOG_BASE_URL'); ?>/atlantis-gala-dinner-a-night-with-the-star-featuring-kylie-minogue-in-dubai/" target="_blank">
                ...
                <div class="item">
                    <div class="card article-card border-0">
                        <a href="<?= getenv('BLOG_BASE_URL'); ?>/havasi-drum-and-piano-concert/" target="_blank">
                ...
                <div class="item">
                    <div class="card article-card border-0">
                        <a href="<?= getenv('BLOG_BASE_URL'); ?>/award-winning-composer-hans-zimmer-to-perform-in-dubai-in-27-january-2023/" target="_blank">
                ...
                <div class="item">
                    <div class="card article-card border-0">
                        <a href="<?= getenv('BLOG_BASE_URL'); ?>/desert-groove-by-groove-on-the-grass-returns-in-29-january-2023/" target="_blank">
