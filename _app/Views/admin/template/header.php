...
<head>
   ...
   <link rel="stylesheet" href="<?php echo base_url(); ?>/assets/plugins/multiselect/css/bootstrap-multiselect.min.css">
      ...
      <div class="navbar-wrapper ">
         ...
         <div class="navbar-content scroll-div">
            <ul class="nav pcoded-inner-navbar">
               ...
               <?php echo view('admin/template/sidebar'); ?>
            ...
            <div class="dropdown drp-user">
               ...
               <div class="dropdown-menu dropdown-menu-right profile-notification">
                  ...
                  <ul class="pro-body">
                     ...
                     <li><a href="<?php echo base_url(); ?>/admin/logout" class="dropdown-item"><i class="feather icon-lock"></i> Log Out</a></li>
                  </ul>
               </div>
            </div>
         </li>
