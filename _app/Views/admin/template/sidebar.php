...
<li class="nav-item <?php echo ($upload_csv_sidebar) ? $upload_csv_sidebar : ""; ?>">
    <a class="nav-link" href="<?php echo base_url(); ?>/admin/upload-keywords-csv">
        <!--<i class="ion ion-md-contact"></i>-->
        <span class="pcoded-micon"><i class="fa fa-code-fork" aria-hidden="true"></i></span>
        <span class="nav-link-text">Upload Keywords CSV</span>
    </a>
</li>
<li class="nav-item <?php echo ($test_thumbnail_sidebar) ? $test_thumbnail_sidebar : ""; ?>">
    <a class="nav-link" href="<?php echo base_url(); ?>/admin/test-thumbnail">
        <!--<i class="ion ion-md-contact"></i>-->
        <span class="pcoded-micon"><i class="fa fa-code-fork" aria-hidden="true"></i></span>
