                    ...
                    <script>
                        ...
                        var dateFormat = "dd-mm-yy",
                            from = $(".move-subcategory-business #date_from").datepicker({
                                dateFormat: 'dd-mm-yy',
                                defaultDate: "+1w",
                                changeMonth: true,
                                numberOfMonths: 1
                                ...
                                localStorage.setItem("minDate_move_subcat_business", getDate(this));
                                if (localStorage.getItem('maxDate_move_subcat_business') != null) {
                                    $(".move-subcategory-business #business_details .row").html("");
                                    ...
                                    if (sub_category != 0) {
                                        $.ajax({
                                            ...
                                            data: {
                                                id: sub_category,
                                                from: localStorage.getItem("minDate_move_subcat_business"),
                                                to: localStorage.getItem("maxDate_move_subcat_business")
                                            },
                                            cache: false,
                                            success: function(returndata) {
                                                // console.log(returndata);
                            ...
                            to = $(".move-subcategory-business #date_to").datepicker({
                                dateFormat: 'dd-mm-yy',
                                defaultDate: "+1w",
                                changeMonth: true,
                                numberOfMonths: 1
                                ...
                                localStorage.setItem("maxDate_move_subcat_business", getDate(this));
                                var sub_category = $('.move-subcategory-business #move_from_sub_category').val();
                                $(".move-subcategory-business #business_details .row").html("");
                                if (sub_category != 0) {
                                    $.ajax({
                    ...
                    <script>
                        ...
                        var dateFormat = "dd-mm-yy",
                            from_multiple_business_category = $(".multiple-business-category #date_from").datepicker({
                                dateFormat: 'dd-mm-yy',
                                defaultDate: "+1w",
                                changeMonth: true,
                                numberOfMonths: 1
                            }).on("change", function() {
                                to_multiple_business_category.datepicker("option", "minDate", getDate(this));
                                localStorage.setItem("minDate_multiple_business_category", getDate(this));
                                if (localStorage.getItem('maxDate_multiple_business_category') != null) {
                                    $(".multiple-business-category #business_details .row").html("");
                                    var sub_category = $('.multiple-business-category #move_from_sub_category').val();
                                    if (sub_category != 0) {
                                        $.ajax({
                                            type: 'post',
                                            url: "<?php echo base_url('/admin/sub-category-business'); ?>",
                                            data: {
                                                id: sub_category,
                                                from: localStorage.getItem("minDate_multiple_business_category"),
                                                to: localStorage.getItem("maxDate_multiple_business_category")
                                            },
                                            cache: false,
                                            success: function(returndata) {
                                                // console.log(returndata);
                            ...
                            to_multiple_business_category = $(".multiple-business-category #date_to").datepicker({
                                dateFormat: 'dd-mm-yy',
                                defaultDate: "+1w",
                                changeMonth: true,
                                numberOfMonths: 1
                            }).on("change", function() {
                                from_multiple_business_category.datepicker("option", "maxDate", getDate(this));
                                console.log(getDate(this));

                                localStorage.setItem("maxDate_multiple_business_category", getDate(this));
                                var sub_category = $('.multiple-business-category #move_from_sub_category').val();
                                $(".multiple-business-category #business_details .row").html("");
                                if (sub_category != 0) {
                                    $.ajax({
