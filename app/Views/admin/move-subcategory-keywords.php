...
<?php $session = session(); ?>
<div class="main-div move-subcategory-keywords">
    <!-- Page Heading Start-->
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12">
            ...
            ?>
            <form method="post" action="<?= base_url() . "/admin/save_move_subcategory_keywords" ?>" class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        <div class="move-from">
                            ...
                            <div class="form-group mb-2">
                                <label class="custom">Keywords: </label>
                                <select class="form-control" id="move_from_keywords" name="move_from_keywords" multiple="multiple">
