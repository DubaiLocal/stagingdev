...
<div class="hk-pg-wrapper">
    ...
    <div class="container-fluid px-xxl-65 px-xl-20">
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Edit Bussiness</h4>
        </div>
        <div class="card-body">

            <form action="<?php echo base_url('admin/business/update/' . md5($bussinesses[0]->id)); ?>" method="POST" enctype="multipart/form-data" id="update_business">
                <?php echo $users[0]->id; ?>
                <div class="form-group mb-2">
                    <label class="custom">Featured Type</label>
                    <select class="form-control" name="featured" id="featured">
                        <?php foreach ($features as $feature) { ?>
                            <option value="<?php echo $feature['Id']; ?>" <?php if ($feature['Id'] == $bussinesses[0]->feature_id) {
