                        ...
                        <div class="col-md-6">
                            <div class="bd_lerightinfos">
                                <div class="bread_crumb bread_crumb2">
                                    <a href="#"><?= $business_data->cat_name; ?></a><i class="fa fa-angle-right" aria-hidden="true"></i><a href="#" class="subcat_bread"><?= $business_data->sub_cat_name; ?></a>
                                </div>
                                ...
                                <div class="bd_adrsinfos">
                                    <div class="ratings mb-2">
                                        <ul class="list-unstyled list-inline">
                                            <?php for ($k = 1; $k <= (int)number_format((float)$business_data->avg_rating, 1, '.', ''); $k++) {
                                            ...
                                            ?>
                                            <li class="list-inline-item ml-3"><span class="badge badge-primary badge-pill"><?= number_format((float)$business_data->avg_rating, 1, '.', ''); ?></span></li>
                                        </ul>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="busi_id" name="busi_id" value="<?= $business_data->name; ?>">
                                    </div>
                                </div>
                                <!-- <div class="col-md-6">
                                    <div class="form-group">
