 <a href="javascript:;" href="#g-map" data-scroll="g-map">
     <section class="our-directory b_listing">
         <div class="">
             ...
             <h1 class="sec-title">Newly Added <span>Businesses</span></h1>
                                     ...
                                     <div class="card">
                                         <div class="bl_img">
                                             <a href="<?php echo base_url() . "/business/" . $business['slug']; ?>">
                                                 <img class="card-img-top" src="<?php echo base_url(); ?>/assets/home-business-thumbnail/280x211-<?php echo $business['banner'] ?>" alt="<?= $business['slug'] ?>">
                                             </a>
                                         </div>
                                         <div class="card-body">
