...
class UserController extends BaseController
{
	...
	public function save_business()
	{
		...
		if ($logo_input) {
			...
			$home_thumbnail = \Config\Services::image()->withFile($logo_img)->resize(280, 211, true, 'height')->save('assets/home-thumbnail/280x211-' . $logo);
	...
	public function update_business($id)
	{
		if ($this->userLoggedIn()) {
			...
			if ($logo_input) {
				...
				$home_thumbnail = \Config\Services::image()->withFile($img)->resize(280, 211, true, 'height')->save('assets/business-thumbnail/280x211-' . $logo);
