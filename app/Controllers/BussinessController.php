...
class BussinessController extends BaseController
{
    ...
    public function save()
    {
        ...
        if ($logo_input) {
            ...
            $home_thumbnail = \Config\Services::image()->withFile($logo_img)->resize(280, 211, true, 'height')->save('assets/home-business-thumbnail/280x211-' . $logo);
    ...
    public function update($id)
    {
        if ($this->IsloggedIn()) {
            ...
            if ($logo_input) {
                ...
                $home_thumbnail = \Config\Services::image()->withFile($img)->resize(280, 211, true, 'height')->save('assets/home-business-thumbnail/280x211-' . $logo);
