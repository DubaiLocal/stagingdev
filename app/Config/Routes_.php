...
$routes->get('/(:segment)', 'FrontController::subcategory_listings_slug/$1');
/* End Category Listing */

/* Sub Category Listing */
$routes->get('/sub-category/(:any)', 'FrontController::subcategory_business_listings/$1');
// $routes->get('/(:segment)/(:segment)', 'FrontController::subcategory_business_listings_slug/$1');
/* End Sub Category Listing */
